...
```{r Spatial point pattern analysis}

# Extract coordinates from the peak SCR value dataframe
peaks_A_coor <- peaks_merged_sf_A[4]
bike_acc_coor <- b[37]
...
peaks_A_ppp <- as.ppp(peaks_A_coor_sp)
accidents_ppp <- as.ppp(st_coordinates(bike_acc_coor), window = window_bb)
