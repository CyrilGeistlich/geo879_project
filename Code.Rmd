...
w <- knn2nb(knearneigh(coords))

# Fit SAR model with spatially autocorrelated errors
sar_model <- errorsarlm(AccidentSeverityCategory_en ~ SCR_phasic, data = nn_A, listw = w)
