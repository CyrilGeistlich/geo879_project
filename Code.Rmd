...
# Convert spatial datasets to point patterns
...
# Create multitype point patterns with different types (1 and 2)
peaks_A_ppp$marks <- rep(1, npoints(peaks_A_ppp))
accidents_ppp$marks <- rep(2, npoints(accidents_ppp))
