...
# Plot Fabienne
plot(EDA_F_filtered$Timestamp, EDA_F_smoothed$EDA, type = 'l', col = 'blue', 
     xlab = 'Time',
     ylab = 'Galvanic Skin Response [µS]',
     main ="GSR and extracted Tonic GSR curve - Fabienne")

# Add the smoothed trend using lines()
lines(EDA_F_filtered$Timestamp, EDA_F_smoothed$tonic_values, col = 'red', lwd = 2)
...
EDA_F_smoothed$phasic_values <- EDA_F_smoothed$GSR_smoothed - EDA_A_smoothed$tonic_values
...
peak_timestamps_F <- EDA_A_smoothed$Timestamp[peak_positions_F]
...
mapview(full_merged_sf_F, 
        zcol = "phasic_values", 
        col.regions = color_palette, 
        cex = ifelse(full_merged_sf_F$phasic_values > 0.01, 3, 1), 
        lwd = 0.01, 
        layer.name = "Phasic SCR")
```
